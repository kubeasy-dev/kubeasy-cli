...
- [x] **INFRA-05**: User voit un message clair si cloud-provider-kind n'est pas en cours d'exécution — avec instructions d'installation (détection seulement, pas auto-install)
